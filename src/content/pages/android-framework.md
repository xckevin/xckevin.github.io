...
- [深入 AOSP 源码阅读方法论：从系统服务调用链到 Native 层实现的源码追踪与调试全链路](/blog/aosp-source-reading-methodology/)
- [深入 Android init 进程与系统启动全链路：从 BootLoader 到 Home Screen 的启动流程架构解析](/blog/android-init-boot-process/)
- [深入 Android Zygote 进程全链路解析：从 init fork 到应用孵化的进程创建架构](/blog/android-zygote-init-fork-process/)
- [深入 Android Task Stack 与 Activity 启动模式全链路](/blog/android-task-stack-launch-modes/)
- [深入 Android PackageManager 全链路：从 APK 解析到 PMS 组件注册与权限校验](/blog/android-packagemanager-pms-apk-parsing/)
- [深入 Android BroadcastReceiver 全链路：从注册机制到 BroadcastQueue 调度引擎的广播分发架构解析](/blog/android-broadcastreceiver-broadcastqueue/)
- [Android WebView 深度解析：从 Chromium 内核架构到 JS Bridge 安全通信](/blog/android-webview-chromium-jsbridge/)
- [深入 Android Watchdog 机制：从 SystemServer 锁监控到系统自动重启的全链路解析](/blog/android-watchdog-systemserver/)
- [深入 Android OTA 系统更新全链路：从 A/B 分区到 Virtual A/B 快照](/blog/android-ota-ab-virtual-ab/)
- [深入 Android 跨进程大数据传输全链路：从 Binder 1MB 限制到 ASharedMemory 零拷贝的进程间数据通道设计](/blog/android-large-ipc-asharedmemory/)
